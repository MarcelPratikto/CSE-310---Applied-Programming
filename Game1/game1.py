...
source: https://api.arcade.academy/en/latest/examples/platform_tutorial/index.html
edited by Marcel Pratikto
TODO: randomly generated environment
"""
import math
import os
import arcade
...
SCREEN_WIDTH = 1000
SCREEN_HEIGHT = 650
SCREEN_TITLE = "Sprint 1 Platformer"
...
class GameView(arcade.View):
    ...
    def __init__(self):
        ...
        self.game_win = arcade.load_sound(":resources:sounds/upgrade1.wav")
    ...
    def on_update(self, delta_time):
        ...
        if len(self.scene[LAYER_NAME_ENEMIES]) == 0:
            arcade.play_sound(self.game_win)
            game_over = GameWinView()
            self.window.show_view(game_over)
            return
